...
const Nav = () => {
  ...
  return (
    <nav data-scroll-section>
      <div
        className="nav flex flex-col py-5 gap-3 justify-between font-medium w-full md:flex-row md:items-center"
      ...
      >
        ...
        <div className="flex flex-col gap-4 md:flex-row items-end md:items-center">
          <span ref={ava} className="translate-x-0 translate-y-[-200px]">
            Available for freelance <br /> work from May 2022
          </span>
          <div className="btn-contact" ref={contact}>
            <a href="" className="translate-x-0 translate-y-[-200px]">
              <button className="py-1 px-2 text-base border border-[#777777] rounded-[44px] uppercase">
                contact
              </button>
            </a>
          </div>
